...
public class ZYSlipButton extends FrameLayout implements View.OnClickListener{
    ...
    private ZYSlipButton.CircleButton button;
    private LayoutParams layoutParams;

    private boolean isSelect;
    private SlipButton.OnSelectChangeListener changeListener;

    public ZYSlipButton(Context context) {
    ...
    public ZYSlipButton(Context context, AttributeSet attrs) {
    ...
    public ZYSlipButton(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initCircleButton() {
        button = new ZYSlipButton.CircleButton(context, null, 0);
    ...
    public void setChangeListener(SlipButton.OnSelectChangeListener changeListener) {
