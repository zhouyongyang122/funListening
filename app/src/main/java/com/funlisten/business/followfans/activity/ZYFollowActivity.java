...
public class ZYFollowActivity extends ZYBaseFragmentActivity<ZYFollowFragment> {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        showTitle("关注");
        new ZYFollowPresenter(mFragment, ZYUserManager.getInstance().getUser().userId, ZYFollowModel.FOLLOW_TYPE);
    }
