...
/** 
 * DAO for table "ZYMARK_BEAN".
*/
public class ZYMarkBeanDao extends AbstractDao<ZYMarkBean, String> {

    public static final String TABLENAME = "ZYMARK_BEAN";

    /**
     * Properties of entity ZYMarkBean.<br/>
    ...
    public ZYMarkBeanDao(DaoConfig config) {
        super(config);
    }
    
    public ZYMarkBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ZYMARK_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ZYMARK_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ZYMarkBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ZYMarkBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public ZYMarkBean readEntity(Cursor cursor, int offset) {
        ZYMarkBean entity = new ZYMarkBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, ZYMarkBean entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(ZYMarkBean entity, long rowId) {
        return entity.getMark_id();
    }
    
    @Override
    public String getKey(ZYMarkBean entity) {
        if(entity != null) {
            return entity.getMark_id();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ZYMarkBean entity) {
